...
$query=mysqli_query($con,"update posts set is_Active=1 where postid='$postid'");
if($query)
{
...
if($_GET['presid'])
{
    ...
    $query=mysqli_query($con,"delete from  posts  where postid='$id'");
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>e-Novine | Manage Posts</title>
...
<?php
$query=mysqli_query($con,"select posts.postid as postid,posts.PostTitle as title,category.CategoryName as category from posts left join category on category.Categoryid=posts.Categoryid where posts.is_Active=0");
