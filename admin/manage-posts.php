...
$query=mysqli_query($con,"update posts set Is_Active=0 where postid='$postid'");
if($query)
{
$msg="Post deleted ";
}
...
<?php
$query=mysqli_query($con,"select posts.postid as postid,posts.PostTitle as title,category.CategoryName as category from posts left join category on category.Categoryid=posts.Categoryid where posts.is_Active=1 ");
