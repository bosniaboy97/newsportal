											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select comments.id,user.username,comments.postingDate,comments.comment,posts.postid as postid,posts.PostTitle from comments join posts on posts.postid=comments.postid left join user on user.username=comments.username where comments.status=0");
$cnt=1;
