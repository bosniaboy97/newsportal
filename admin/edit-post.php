...
$query=mysqli_query($con,"update posts set PostTitle='$posttitle',Categoryid='$catid',PostDetails='$postdetails',Is_Active='$status' where id='$postid'");
if($query)
{
$msg="Post updated ";
}
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select posts.postid as postid,posts.PostImage,posts.PostTitle as title,posts.PostDetails,category.CategoryName as category,category.Categoryid as catid from posts left join category on category.Categoryid=posts.Categoryid where posts.postid='$postid' and posts.is_Active=1 ");
